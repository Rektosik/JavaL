...
class ValidationHelper {
    static void requireNonEmpty(String value, String fieldName) {
        if (value == null || value.isBlank()) throw new IllegalArgumentException(fieldName + " cannot be empty");
    }
    ...
    static void requireDateNotPast(LocalDate date, String fieldName) {
        ...
        if (date.isBefore(LocalDate.now())) throw new IllegalArgumentException(fieldName + " cannot be in the past");
    }
}
